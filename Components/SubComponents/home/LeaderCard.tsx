...
const LeaderCard: React.FC<LeaderCardProps> = ({ data }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-start text-center p-4 shrink-0 w-80 sm:w-96 md:w-80 lg:w-96 mr-8">
      {/* Image Container: Aspect ratio 1:1, cropped and rounded */}
      <div className="w-[280px] h-[350px] aspect-square overflow-hidden rounded-xl shadow-xl border border-white/5 mb-6">
        <img
          src={imagePath}
